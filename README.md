...
`eta0`を高めると平均・中央値・上方裾が大きく上昇する一方、標準偏差も22.97から46.72へ拡大します。q05は状態格子上で39.14にとどまりますが、下方5%平均は33.44から30.70へ低下するため、極端な下方リスクは悪化しています。丸め前の値は [`dtcmv_mvs_fixed_gamma_distribution_table.csv`](results/dtcmv_mvs_fixed_gamma_distribution_table.csv) に収録しています。
